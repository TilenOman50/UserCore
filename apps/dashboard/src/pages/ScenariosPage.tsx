    ...
    <div className="p-8">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">Define automated rules and actions for user events</p>
        </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <p className="text-sm text-gray-500 text-center py-8">No scenarios defined yet. Create one to get started.</p>
      </div>
    </div>
  );
};
